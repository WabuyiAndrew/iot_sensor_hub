...
// import { Plus, Minus, Droplet, TrendingUp, TrendingDown } from "lucide-react"

// const VolumeMonitor = ({ volumeHistory, tank, timeRange }) => {
...
//       const current = sortedHistory[i].volumeLiters
//       const previous = sortedHistory[i - 1].volumeLiters
//       const change = current - previous

//       // Filter significant changes (>= 5L to avoid sensor noise)
...
//         </h3>
//         <p className="text-sm text-gray-500 dark:text-gray-400">{volumeHistory.length} readings analyzed</p>
//       </div>
...
//                 {((volumeData.volumeRemaining / (tank?.capacity || 1)) * 100).toFixed(1)}%
//               </p>
//             </div>
//           </div>
...
//           <div>
//             <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Net Change</h4>
//             <p
//               className={`text-lg font-bold ${
//                 volumeData.netChange >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"
//               }`}
//             >
