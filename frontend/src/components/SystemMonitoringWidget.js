...
// // const SystemMonitoringWidget = ({ className = "", showDetails = false, refreshInterval = 30000 }) => {
...
// //                 {systemStats?.error && <p className="text-xs text-red-500 mt-1">{systemStats.error}</p>}
// //               </div>
// //             )}
// //           </div>
// //         </div>
